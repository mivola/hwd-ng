...
public abstract class GwtRpcDataSource<T> extends DataSource {
	 ...
	 * 
	 * @param jsObj
	 *            <code>JavaScriptObject</code> data object containing values
	 *            for
	 * @param fieldName
			...
			if (operator != null) {
				...
				if ("AdvancedCriteria".equalsIgnoreCase(JSOHelper.getAttribute(jsObj, "_constructor"))) {
					...
					if (OPERATOR_EQ.equalsIgnoreCase(operator))
						...
						return new GWTCriterion(GWTCriterionType.not,
								new GWTCriterion(GWTCriterionType.contains, fieldName, value));
						...
						return new GWTCriterion(GWTCriterionType.not,
								new GWTCriterion(GWTCriterionType.begins, fieldName, value));
						...
						return new GWTCriterion(GWTCriterionType.not,
								new GWTCriterion(GWTCriterionType.ends, fieldName, value));
					...
					return new GWTCriterion(GWTCriterionType.eq, properties[0],
	 ...
	 * @param field
	 *            <code>ITypedEnum</code> field requested from the DTO bean
	 * @return
	 */
